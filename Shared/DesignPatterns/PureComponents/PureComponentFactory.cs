...
using Shared.DesignPatterns.PureComponents.Gas.Others;
using Shared.DesignPatterns.PureComponents.Gas.Water;
using Shared.DesignPatterns.PureComponents.Liquido;
using Shared.DesignPatterns.PureComponents.Liquido.Others;
using Shared.DesignPatterns.PureComponents.Liquido.Water;
...
namespace Shared.DesignPatterns.NewFolder
{
    public static class PureComponentFactory
    {
     ...
     : new GasEnthalpyEvaluator(
         ...
         hvapEval,
         tsatEval,
         new Pressure(1.01325, PressureUnits.Bar),
         dto.MolecularWeight);
