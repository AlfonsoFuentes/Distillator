...
namespace Shared.SolverConsecutive
{
    ...
    //}
    //public interface IVariable2<T> : IVariable2 where T : Amount
    //{
    ...
    //}
    //public class Variable2<T> : IVariable2<T> where T : Amount
    //{
    //    private T _value;
    ...
    //    public Variable2(T initialValue, UnitMeasure displayUnit, double _normalizeValue, bool _IsCleareable = false)
    //    {
