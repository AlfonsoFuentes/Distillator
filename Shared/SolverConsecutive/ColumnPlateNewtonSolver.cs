...
{
    public class ColumnPlateNewtonSolver : INewtonSolver
    {
        ...
        {
            equation = _equation;
            _adjustableVariables = equation.Variables;
        ...
        private double[,] CalculateJacobian(double[] x_base, double[] F_base)
        {
            ...
            for (int j = 0; j < n; j++)
            {
                ...
                _adjustableVariables[j].SetValueFromSolver(originalValue + h, VariableDefinedBy.Solver);
