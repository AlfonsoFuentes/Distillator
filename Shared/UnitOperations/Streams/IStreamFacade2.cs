...
namespace Shared.UnitOperations.Streams
{
    ...
    public interface IStreamFacade2 : IFacade
    {
    ...
    public class StreamFacade2 : IStreamFacade2
    {
        ...
        public NewNewVariableDouble MolecularWeight { get; set; }
        public StreamFacade2()
        {
            ...
            MolecularWeight = new NewNewVariableDouble(0);
        ...
        private void OnEquilibriumReady()
        {
            ...
            MolarEnthalpy.SetValueFromStream(MaterialStream.MolarEnthalpy, Name);
            ...
            MolecularWeight.SetValueFromStream(MaterialStream.MolecularWeight, Name);
        ...
        void CalculateMolecularWeight()
        {
            ...
            if (StreamComposition.IsDefined)
            {
                MolecularWeight.SetValueFromStream(MaterialStream.MolecularWeight, Name);
            }
            else
            {
                MolecularWeight.ClearFromStream();
            }
        ...
        {
            StreamStateType.Created => "#CBD5E0",              // Gris
            StreamStateType.MethodDefined => "#F6AD55",        // Naranja
            StreamStateType.EquilibriumCalculated => "#63B3ED",// Azul
            StreamStateType.StreamCalculated => "#34D399",     // Verde
            _ => "#CBD5E0"
        };
