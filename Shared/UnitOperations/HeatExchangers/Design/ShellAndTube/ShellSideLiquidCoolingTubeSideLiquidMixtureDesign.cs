...
public sealed class ShellSideLiquidCoolingTubeSideLiquidMixtureDesign : HeatExchangerDesign
{
    public ShellSideLiquidCoolingTubeSideLiquidMixtureDesign(HeatExchangerDesignRequest request)
        : base(request)
    {
    }

    protected override string DesignType => nameof(ShellSideLiquidCoolingTubeSideLiquidMixtureDesign);
