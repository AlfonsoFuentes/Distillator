...
public sealed class ShellSideVaporCondensingTubeSideLiquidMixtureDesign : HeatExchangerDesign
{
    public ShellSideVaporCondensingTubeSideLiquidMixtureDesign(HeatExchangerDesignRequest request)
        : base(request)
    {
    }

    protected override string DesignType => nameof(ShellSideVaporCondensingTubeSideLiquidMixtureDesign);
    ...
    protected override void CalculateTubeSideHeatTransferCoefficient() => CalculateLiquidMixtureTubeSideHeatTransferCoefficient();
    ...
    protected override void CalculateShellSideHeatTransferCoefficient() =>
        CalculateMixtureCondensingShellSideHeatTransferCoefficient();
