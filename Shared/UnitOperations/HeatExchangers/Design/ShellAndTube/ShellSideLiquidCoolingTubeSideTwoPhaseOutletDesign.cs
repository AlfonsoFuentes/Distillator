...
public class ShellSideLiquidCoolingTubeSideTwoPhaseOutletDesign : HeatExchangerDesign
{
    public ShellSideLiquidCoolingTubeSideTwoPhaseOutletDesign(HeatExchangerDesignRequest request)
        : base(request)
    {
    }

    protected override string DesignType => nameof(ShellSideLiquidCoolingTubeSideTwoPhaseOutletDesign);
