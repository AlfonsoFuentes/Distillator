...
public sealed class ShellSideVaporMixtureCondensingTubeSideLiquidWaterDesign : HeatExchangerDesign
{
    public ShellSideVaporMixtureCondensingTubeSideLiquidWaterDesign(HeatExchangerDesignRequest request)
        : base(request)
    {
    }

    protected override string DesignType => nameof(ShellSideVaporMixtureCondensingTubeSideLiquidWaterDesign);
