...
public sealed class ShellSidePureWaterVaporCondensingTubeSideLiquidWaterDesign : HeatExchangerDesign
{
    public ShellSidePureWaterVaporCondensingTubeSideLiquidWaterDesign(HeatExchangerDesignRequest request)
        : base(request)
    {
    }

    protected override string DesignType => nameof(ShellSidePureWaterVaporCondensingTubeSideLiquidWaterDesign);
    ...
    protected override void CalculateShellSideHeatTransferCoefficient() =>
        CalculatePureWaterCondensingShellSideHeatTransferCoefficient();
