...
namespace Shared.SolverQwen.Stream
{
    ...
    public class ComponentFacade
    {
        ...
        public ProcessVariable<Percentage> MassFraction { get; }
        public ProcessVariable<Percentage> MolarFraction { get; }
        ...
        public ComponentFacade(MethodComponentFullDto database)
        {
            ...
            MassFraction = new ProcessVariable<Percentage>(new Percentage(0, PercentageUnits.Percentage), PercentageUnits.Percentage, 100, true);
            MolarFraction = new ProcessVariable<Percentage>(new Percentage(0, PercentageUnits.Percentage), PercentageUnits.Percentage,100);
            MassFlow = new ProcessVariable<MassFlow>(new MassFlow(0, MassFlowUnits.Kg_sg), MassFlowUnits.Kg_hr, 3, true);
