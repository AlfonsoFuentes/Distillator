    ...
    public class CompMolarFlowStrategy : IFlowsStrategy
    {
        ...
        public void Execute()
        {
            ...
            foreach (var comp in _facade.Composition.Components)
            {
                ...
                CalculatedVariableSetter.SetStreamCalculated(comp.MolarFraction, new Percentage((compMolarFlow / totalMolarFlow) * 100, PercentageUnits.Percentage));
                CalculatedVariableSetter.SetStreamCalculated(comp.MassFraction, new Percentage((compMassFlowBase / totalMassFlowBase) * 100, PercentageUnits.Percentage));
            }
