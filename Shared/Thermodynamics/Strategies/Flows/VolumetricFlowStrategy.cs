...
namespace Shared.Thermodynamics.Strategies.Flows
{
    ...
    public class VolumetricFlowStrategy : IFlowsStrategy
    {
        ...
        public void Execute()
        {
            ...
            {
                if (comp.MassFlow.DataProcedence != VariableDataProcedence.UserInput    )
                {
    ...
    public class VolumetricFlowStrategy3 : IFlowsStrategy
    {
        private readonly IStreamFacade _facade;
        public VolumetricFlowStrategy3(IStreamFacade facade)
        {
            _facade = facade;
        }
        public void Execute()
    ...
    public class VolumetricFlowStrategy2 : IFlowsStrategy
    {
        ...
        public VolumetricFlowStrategy2(IStreamFacade2 facade)
        {
            _facade = facade;
        }
        public void Execute()
