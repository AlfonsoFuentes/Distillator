    ...
    public class CompMassFlowStrategy : IFlowsStrategy
    {
        ...
        public void Execute()
        {
            ...
            foreach (var comp in _facade.Composition.Components)
            {
                ...
                comp.MassFraction.SetValue(new Percentage((compMassFlow / totalMassFlow) * 100, PercentageUnits.Percentage), VariableDataProcedence.StreamCalculated);
                comp.MolarFraction.SetValue(new Percentage((compMolarFlowBase / totalMolarFlowBase) * 100, PercentageUnits.Percentage), VariableDataProcedence.StreamCalculated);
            }
