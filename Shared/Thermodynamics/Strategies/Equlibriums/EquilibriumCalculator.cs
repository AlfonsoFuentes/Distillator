...
namespace Shared.Thermodynamics.Strategies.Equlibriums
{
    ...
    public class EquilibriumCalculator
    {
        ...
        public Action? EquilibriumReady;
        ...
        private GibbsValidationResult ValidateComposition()
        {
            ...
            if (firstComponent?.MolarFractionSolver.IsDefined == true)
            {
                sum = composition.Components.Sum(c => c.MolarFractionSolver.Value);
            }
            else if (firstComponent?.MassFractionSolver.IsDefined == true)
            {
    ...
    public class EquilibriumCalculator2
    {
        ...
        private double VaporFraction => _facade.VaporFraction.SolverValue;
        ...
        // ✅ Constructor inyecta interfaz
        public EquilibriumCalculator2(IStreamFacade facade)
        {
            _facade = facade;  // ← No conoce el Facade concreto
