...
namespace Client.Services.EquipmentManagers
{
    ...
    public class WorkspaceManager
    {
        ...
        public WorkspaceManager(IEquipmentFactory factory, IMainSolver solver)
        {
            _factory = factory;
            _solver = solver;
        ...
        public void AddFromToolbox(EquipmentType type, double offsetX, double offsetY)
        {
            ...
            if (el != null)
            {
                ...
                if (el.Facade != null)
                {
                    ...
                    else if (el.Facade is ISolverEquipment e) _solver.AddEquipment(e);
                }
                UpdateDiagramSize();
                NotifyStateChanged();
            }
        ...
        public void RunSimulation()
        {
            ...
            // 2. Notificar a la UI que terminó
            NotifyStateChanged();
        }
    }
